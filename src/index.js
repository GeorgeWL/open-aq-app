...
const floatStyle = `font-family: 'IBM Plex Sans', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Noto Sans', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'Noto Color Emoji'; position: fixed; left: calc(100vw - 210px); top: 90vh; width: 200px; display: flex; flex-direction: row; align-items: center; justify-content: space-evenly; padding: 0 5px; background: rgba(0, 0, 0, 0.1); color: black; mix-blend-mode: difference; border-radius: 5px; box-shadow: rgba(0, 0, 0, 0.05) 0px 1px 2px 0px;`;
const innerHTML = `
